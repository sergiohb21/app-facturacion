          ...
          {Object.keys(stats.invoicesByYear).length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {Object.entries(stats.invoicesByYear)
                ...
                .map(([year, data]) => (
                  <div key={year} className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
          ...
          {Object.keys(stats.invoicesByModel).length === 0 ? (
            ...
            <div className="space-y-4">
              {Object.entries(stats.invoicesByModel)
                ...
                .map(([modelId, data]) => (
                  <div key={modelId} className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
                    <div className="flex items-center justify-between mb-2">
                      <h4 className="font-semibold">{data.modelName}</h4>
            ...
            <div className="space-y-3">
              {recentRecords.map((record) => (
                <div key={record.id} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="font-medium">{record.modelName}</p>
              ...
              {recentRecords.length >= 10 && (
                <div className="text-center pt-4">
                  <Button variant="outline" onClick={toggleShowAllRecords}>
